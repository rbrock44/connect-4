...
- `Select Player 2`
  ...
  - AI - Iterative -> This version learns as you play. It tracks recent game outcomes and winning patterns (saved in your browser's local storage), gradually tuning its move weights toward AI - Hard-level play.
